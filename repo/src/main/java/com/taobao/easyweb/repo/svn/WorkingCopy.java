...
public class WorkingCopy {
	...
	public static void main(String[] args) throws SVNException {
		...
		try {
			repositoryURL = SVNURL.parseURIEncoded("http://code.taobao.org/svn/sm_cmsadmin/trunk");
		} catch (SVNException e) {
			//
		}
		String name = "shantoong";
		String password = "shantong";
		...
		// * history
		// */
		// //committedRevision = copy(url, copyURL, false, "remotely copying '"
		// + url + "' to '" + copyURL + "'").getNewRevision();
		// } catch (SVNException svne) {
		...
		System.out.println("Switching '" + wcDir.getAbsolutePath() + "' to '" + copyURL + "'...");
		try {
			/*
	...
	private static SVNCommitInfo copy(SVNURL srcURL, SVNURL dstURL, boolean isMove, String commitMessage) throws SVNException {
		...
		// return ourClientManager.getCopyClient().doCopy(null,srcURL,
		// SVNRevision.HEAD,
